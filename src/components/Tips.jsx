...
export default function Tips({ analysis }) 
{
  ...
  if (analysis.minuteCounts.Awake > 30) tips.push('Riduci le interruzioni notturne (es. rumore).'); // genera un consiglio se rimani sveglio piu' di un tot. 
  if ((analysis.minuteCounts.Deep + analysis.minuteCounts.REM) / analysis.totalMin < 0.25) 
    tips.push('Favorisci fasi profonde: evita caffeina/la luce blu prima di dormire.'); // genera un consiglio se le fasi profonde sono meno del 25% 
