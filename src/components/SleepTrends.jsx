...
export default function SleepTrends({ records }) {
  ...
  return (
    <div className="Trends">
      ...
      <LineChart width={800} height={300} data={chartData} className="Trends-chart">
        ...
        />
        <Line type="monotone" dataKey="minutes" stroke="#8884d8" strokeWidth={2} dot />
      </LineChart>
    </div>
  );
}
